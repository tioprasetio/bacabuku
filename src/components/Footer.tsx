        ...
        <div className="mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
            ...
            >
              ...
              <div className="flex mb-4">
                <div className="footer-text">
                  Jl. Raya Piyungan - Prambanan Km. 4.5, Madubaru, Madurejo,
              ...
              <div className="flex mb-4 gap-1">
                ...
                <div className="footer-text">sma1pramb@gmail.com</div>
              </div>
              <div className="flex mb-4 gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="footer-text">0274496753</div>
              </div>
            </div>
            ...
            >
              ...
              <ul>
                <li className="mb-2">
                  <Link to="/tujuan">Tujuan Kami</Link>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              <ul>
                <li className="mb-2">
                  <Link to="/cara-baca">Cara Baca Buku</Link>
                </li>
              </ul>
            </div>
